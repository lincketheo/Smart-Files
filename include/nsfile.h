...
// Switch contexts
int smfile_load (smfile_t *ns, const char *vname);
...
sb_size smfile_write (smfile_t *smf, const void *src, t_size size, b_size bofst, sb_size stride, b_size nelem);
sb_size smfile_read (smfile_t *smf, void *dest, t_size size, b_size bofst, sb_size stride, b_size nelem);
sb_size smfile_remove (smfile_t *smf, void *dest, t_size size, b_size bofst, sb_size stride, b_size nelem);

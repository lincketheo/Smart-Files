...
void *i_realloc_right (void *ptr, u32 old_nelem, u32 nelem, u32 size,
                       error *e);
void *i_realloc_left (void *ptr, u32 old_nelem, u32 nelem, u32 size, error *e);
void *i_crealloc_right (void *ptr, u32 old_nelem, u32 nelem, u32 size,
                        error *e);
void *i_crealloc_left (void *ptr, u32 old_nelem, u32 nelem, u32 size,
                       error *e);
